# you can define common configuration in base/parent class to be used by all other classes.

from pydantic import BaseModel, ValidationError, Field, ConfigDict, AfterValidator, \
                    EmailStr, PastDate
...
class RequestInfo(CustomBaseModel):
    ...
    execution_dt: datetime = Field(default_factory=lambda: datetime.now(pytz.utc))
...
users = Users(users=['a','b'],request_info=RequestInfo(elapsed_time_secs=10))
print(users)
